...
@XmlRootElement(name = "responseConsultarPosicaoEstoquePorCNESPrincipioAtivoPaginado")
public class ResponseConsultarPosicaoEstoquePorCNESPrincipioAtivoPaginado {
